...
%type <dlist> Body
%type <dlist> Dclns_1
%type <dlist> Expression1
%type <dlist> Caselabel
%type <dlist> Expression2
%type <dlist> Caseclause
%type <dlist> Statement_1_1_1_1
%type <dlist> Expression3
%type <dlist> Type
%type <dlist> Expression4
...
Statement : Name     ASSIGNMENT Expression 
		...
		$$ = r;
         ...
         | CASE     Expression OF       Statement_1_1_1_1 
             {
		DLIST r;
		T_NODE *t;
...
Statement_1_1_1_1 : OtherwiseClause END      
             {
		DLIST r;
...
Statement_1_1_1 : Statement POOL     
             {
		DLIST r;
...
Statement_1_1 : Statement UNTIL    Expression 
             {
		DLIST r;
...
Caseclause_1 : Caselabel ':'      Statement 
             {
		DLIST r;
