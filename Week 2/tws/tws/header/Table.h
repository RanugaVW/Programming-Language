...
#define CharacterElement(T, I)                                                 \
  ((I < T->Size) ? (((T->Contents) + I)->ch) : '\0')
...
#define PushCharacter(S, obj) CharacterAssign(S, ++(S->Current_Size), obj)
...
#define TopCharacter(Stack) CharacterElement(Stack, Stack->Current_Size)
...
#define SizeOf(Object)                                                         \
  (((Object->Parameters).is_stack) ? (Object->Current_Size) : (Object->Size))
