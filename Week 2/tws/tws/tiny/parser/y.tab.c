...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_DO = 12,                        /* DO  */
  YYSYMBOL_BEGINX = 13,                    /* BEGINX  */
  YYSYMBOL_BOOLEAN = 14,                   /* BOOLEAN  */
  YYSYMBOL_INTEGER_NUM = 15,               /* INTEGER_NUM  */
  ...
  YYSYMBOL_Tiny = 29,                      /* Tiny  */
  YYSYMBOL_Dclns = 30,                     /* Dclns  */
  YYSYMBOL_Dclns_1 = 31,                   /* Dclns_1  */
  YYSYMBOL_Dcln = 32,                      /* Dcln  */
  YYSYMBOL_Dcln_1 = 33,                    /* Dcln_1  */
  YYSYMBOL_Type = 34,                      /* Type  */
  YYSYMBOL_Body = 35,                      /* Body  */
  YYSYMBOL_Body_1 = 36,                    /* Body_1  */
  YYSYMBOL_Statement = 37,                 /* Statement  */
  YYSYMBOL_Expression = 38,                /* Expression  */
  YYSYMBOL_Term = 39,                      /* Term  */
  YYSYMBOL_Primary = 40,                   /* Primary  */
  YYSYMBOL_Name = 41                       /* Name  */
};
...
static const char *const yytname[] =
{
  ...
  "IDENTIFIER", "IF", "READ", "ELSE", "THEN", "WHILE", "OUTPUT", "DO",
  "BEGINX", "BOOLEAN", "INTEGER_NUM", "INTEGER", "LTE", "ASSIGNMENT",
  "PROGRAM", "':'", "'.'", "';'", "','", "'('", "')'", "'+'", "'-'",
  "$accept", "Tiny", "Dclns", "Dclns_1", "Dcln", "Dcln_1", "Type", "Body",
  "Body_1", "Statement", "Expression", "Term", "Primary", "Name", YY_NULLPTR
};
...
#line 1860 "y.tab.c"
  ...
  case 22: /* Expression: Term LTE Term  */
#line 623 "code.y"
             {
		DLIST r;
		T_NODE *t;
