...
extern void setyyin(char *in);
extern void closeyyin(void);
...
int Lf(int i) { return (Element(Data, GBR + LocalAddress(i))); }

int Gf(int i) { return (Element(Data, GBR + GlobalAddress(i))); }

void UpdateLf(int i, int v) { Assign(Data, GBR + LocalAddress(i), v); }

void UpdateGf(int i, int v) { Assign(Data, GBR + GlobalAddress(i), v); }
...
int TopLf(void) { return (Element(Data, STR)); }
...
int DepthLf(void) { return (STR - LBR + 1); }
